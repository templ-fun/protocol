...
contract DemocracyDeployer {
  ...
  /// @notice Deploy a new Democracy for an existing templ via a passing governance
  ...
  ///         resulting Democracy would be orphaned (can only act on the
